...
| `aps-lh/.../context/LhScheduleContext.java` | 修改：新增 `shiftRuntimeStateMap` |
...
```bash
git add aps-lh/src/main/java/com/zlt/aps/lh/context/LhScheduleContext.java
git commit -m "feat(lh): LhScheduleContext 增加 shiftRuntimeStateMap"
```
